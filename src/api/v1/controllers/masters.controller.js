...
const { fetchStates, fetchCities, fetchPaymentStatuses, fetchPaymentModes, fetchGSTSlabs, fetchProductUnits, insertContactRole, updateContactRoleById, getAllContactRolesModel, getContactRoleByIdModel, fetchContactRolesMeta, deleteContactRoleMaster, bulkDeleteContactRoles: bulkDeleteContactRolesModel, restoreContactRoleById, bulkRestoreContactRoles: bulkRestoreContactRolesModel } = require("../models/masters.model");
